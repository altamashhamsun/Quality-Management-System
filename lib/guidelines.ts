...
export const GUIDELINES_BY_DEPARTMENT: Record<string, Guideline[]> = {
  Kitchen: [
    ...
    { id: "k4", name: "Cross-Contamination Prevention", standard: "HACCP", clause: "Principle 1 – Hazard analysis" },
    { id: "k5", name: "Critical Control Point (CCP) Monitoring", standard: "HACCP", clause: "Principle 4 – Establish monitoring" },
